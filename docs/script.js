...
const translations = {
  es: {
    ...
    hero_subtitle: "Convierte cualquier control genérico USB, mando de PlayStation, palanca arcade o teclado en mandos oficiales de Xbox 360 (XInput) con precisión milimétrica y compatibilidad total en PC. Desarrollado por JuanJSAR.",
    ...
    req_row_inputs_val1: "Cualquier Gamepad USB / Bluetooth / Teclado",
    req_row_inputs_val2: "Gamepads compatibles con DirectInput o estándar",
    ...
    faq_q3: "¿Puedo usar teclado para jugar como un mando de Xbox?",
    faq_a3: "Sí. En la asignación de dispositivo puedes seleccionar 'Teclado' y mapear las teclas que prefieras (WASD para sticks, teclas para botones A/B/X/Y, etc.).",
  ...
  en: {
    ...
    hero_subtitle: "Turn any generic USB controller, PlayStation gamepad, arcade stick, or keyboard into official Xbox 360 controllers (XInput) with pinpoint accuracy and full PC compatibility. Developed by JuanJSAR.",
    ...
    req_row_inputs_val1: "Any USB / Bluetooth Gamepad / Keyboard",
    req_row_inputs_val2: "DirectInput or standard compatible gamepads",
    ...
    faq_q3: "Can I use my keyboard as an Xbox controller?",
    faq_a3: "Yes! In the device dropdown, select 'Teclado' (Keyboard) and map whichever keys you prefer (WASD for sticks, spacebar, etc.).",
